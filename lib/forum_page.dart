                                  ...
                                  child: Column(
                                    children: [
                                      ListTile(
                                        ...
                                        title:
                                            Text(announcementPostList[i].title),
                                        subtitle: Text(
                                            announcementPostList[i].writer),
                                        onTap: () {
                                          Navigator.push(
                                            context,
                                            MaterialPageRoute(
                                              builder: (context) =>
                                                  OneAnnouncementPage(i),
                                            ),
                                          ).then((value) => setState(() {}));
                                        },
                                      ),
                                  ...
                                  child: Column(
                                    children: [
                                      ListTile(
                                        // leading: const Icon(Icons.restaurant),
                                        title:
                                            Text(studentVoicePostList[i].title),
                                        subtitle: Text(
                                            studentVoicePostList[i].writer),
                                        onTap: () {
                                          Navigator.push(
                                            context,
                                            MaterialPageRoute(
                                              builder: (context) =>
                                                  OneStudentVoicePage(i),
                                            ),
                                          ).then((value) => setState(() {}));
                                        },
                                      ),
                                            ...
                                            children: <Widget>[
                                              ActionChip(
                                                avatar: Icon(Icons.thumb_up,
                                                    color: (myEvalForStudentVoicePostList[
                                                                i]
                                                            .isLiked)
                                                        ? Colors.redAccent
                                                        : Theme.of(context)
                                                ...
                                                onPressed: () {
                                                  setState(() {
                                                    if (myEvalForStudentVoicePostList[
                                                            i]
                                                        .isLiked) {
                                                      studentVoicePostList[i]
                                                          .like--;
                                                      myEvalForStudentVoicePostList[
                                                              i]
                                                          .isLiked = false;
                                                    } else {
                                                      if (myEvalForStudentVoicePostList[
